...
public class Residentes {
    ...
    private String nombresResidentes;
    private String apellidosResidentes;

    public Residentes(String nombres, String apellidos, String cedula, String telefonoMovil, String telefonoConvencional, String numeroVivienda, String direccion, boolean tieneMascotas, String numeroVehiculos, String numeroPersonas, String nombresResidentes, String apellidosResidentes) {
    ...
    public String getNombresResidentes() {
        return nombresResidentes;
    }

    public void setNombresResidentes(String nombresResidentes) {
        this.nombresResidentes = nombresResidentes;
    }

    public String getApellidosResidentes() {
        return apellidosResidentes;
    }

    public void setApellidosResidentes(String apellidosResidentes) {
        this.apellidosResidentes = apellidosResidentes;
    }
