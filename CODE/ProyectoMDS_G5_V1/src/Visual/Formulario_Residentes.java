...
public class Formulario_Residentes extends javax.swing.JFrame implements interfaz_residentes {
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(Formulario_Residentes.class.getName());
    ...
    public Formulario_Residentes() {
        initComponents();
        inicializarTabla();
        //AlmacenarResidentes modelo = new AlmacenarResidentes();
    ...
    private void inicializarTabla() {
        modeloTabla = new DefaultTableModel(
            new String[]{"Nombre Completo", "Cédula", "N° Vivienda"}, 0
        ) {
            @Override
        ...
        table_residentes.getColumnModel().getColumn(0).setPreferredWidth(350);
        table_residentes.getColumnModel().getColumn(1).setPreferredWidth(180);
        table_residentes.getColumnModel().getColumn(2).setPreferredWidth(100);
        table_residentes.getTableHeader().setBackground(java.awt.Color.BLACK);
        table_residentes.getTableHeader().setForeground(java.awt.Color.WHITE);
    }

    // ── @Override de interfaz_residentes ────────────────────────
    @Override
    public String getNombres() { return txt_nombresp.getText(); }
    @Override
    ...
    @Override
    public String getApellidos() { return txt_apellidosp.getText(); }

    @Override
    public String getCedula() { return txt_cedula.getText(); }

    @Override
    public String getTelefonoMovil() { return txt_telefonom.getText(); }

    @Override
    public String getTelefonoConvencional() { return txt_telefonoc.getText(); }

    @Override
    public String getNumeroVivienda() { return (String) box_vivienda.getSelectedItem(); }

    @Override
    public String getDireccion() { return txt_direccion.getText(); }

    @Override
    public boolean getTieneMascotas() { return jRadioButton1.isSelected(); }

    @Override
    public String getNumeroVehiculos() { return txt_vehiculos.getText(); }

    @Override
    public String getNumeroPersonas() { return txt_numeror.getText(); }

    @Override
    public String getNombresResidentes() { return txt_nombresr.getText(); }

    @Override
    public String getApellidosResidentes() { return txt_apellidosr.getText(); }
    ...
    private void initComponents() {
        ...
        txt_apellidosr = new javax.swing.JTextField();
        ...
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 10, 160, 20));
        ...
        jPanel1.add(txt_nombresr, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 310, 280, 50));
        ...
        jPanel1.add(txt_apellidosr, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 310, 310, 60));
        ...
        jPanel1.add(BtnGuardar, new org.netbeans.lib.awtextra.AbsoluteConstraints(920, 200, -1, -1));
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 400, 980, 310));
    ...
    public javax.swing.JTextField txt_apellidosr;
