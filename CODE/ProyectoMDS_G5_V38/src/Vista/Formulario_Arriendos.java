...
public class Formulario_Arriendos extends JFrame implements interfaz_arriendos {
    ...
    private void initComponents() {
        ...
        btnEliminar  = mkBtn("🚫 Anular",             new Color(150, 80, 0),   Color.WHITE);
    ...
    private void agregarListeners() {
        ...
        comboTipoArr.addActionListener(e -> {
            ...
            if (!esRes) {
                // Limpiar datos autocompletados al cambiar a Externo
                txtNombre.setText(""); txtTelefono.setText(""); txtEmail.setText("");
            }
        });
        // Cuando cambia el N° Casa (si es Residente), autocompletar datos
    ...
    private void autocompletarPorCasa() {
        if (!"Residente".equals(comboTipoArr.getSelectedItem())) return;
        String casa = txtCasa.getText().trim();
        if (casa.isEmpty()) { txtNombre.setText(""); txtTelefono.setText(""); txtEmail.setText(""); return; }
        Modelo.AlmacenarArriendos repo = new Modelo.AlmacenarArriendos();
    ...
    @Override public String    getMontoMensualTexto()    { return txtMonto.getText().trim(); }
