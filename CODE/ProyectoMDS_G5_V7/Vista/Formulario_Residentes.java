...
public class Formulario_Residentes extends javax.swing.JFrame implements interfaz_residentes {
    ...
    public Formulario_Residentes() {
        ...
        ajustarFilasVehiculos(); // spinner arranca en 0 → campos bloqueados desde el inicio
    }
    ...
    private void initComponents() {
        ...
        // Al cambiar el spinner, ajustar habilitación de campos
    ...
    /** Cuando el spinner es 0, bloquea los campos de vehículos. Si sube, los habilita. */
    private void ajustarFilasVehiculos() {
        int n = (int) spinnerNumVeh.getValue();
        boolean habilitar = n > 0;

        if (n == 0) {
            modeloVehiculos.setRowCount(0);
        }

        txtPlaca.setEnabled(habilitar);
        txtPlaca.setBackground(habilitar ? Color.WHITE : new Color(235, 235, 235));
        comboTipoVeh.setEnabled(habilitar);
        btnAgregarVeh.setEnabled(habilitar);
        btnEliminarVeh.setEnabled(habilitar);
    }
    ...
    public void limpiarCampos() {
        ...
        ajustarFilasVehiculos(); // bloquear campos al limpiar
    }
