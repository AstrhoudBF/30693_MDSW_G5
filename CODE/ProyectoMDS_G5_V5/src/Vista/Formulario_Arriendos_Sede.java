...
public class Formulario_Arriendos_Sede extends JFrame implements interfaz_arriendos_sede {
    ...
    private void initComponents() {
        ...
        btnEditar    = mkBtn("✏ Editar seleccionada", new Color(30, 100, 180), Color.WHITE);
