...
public class Residentes {
    ...
    private String        estadoResidente; // "Activo" | "Cancelado"
    ...
    public String getEstadoResidente()                 { return estadoResidente != null ? estadoResidente : "Activo"; }
    public void   setEstadoResidente(String v)         { this.estadoResidente = v; }
