...
import Vista.Formulario_Consultas;
...
public class controlador_menu {
    ...
    public controlador_menu(interfaz_menu vista) {
        ...
        this.vista.getBtnConsultas().addActionListener(e     -> irConsultas());
    }

    private JFrame menuFrame() { return (JFrame) this.vista; }
    ...
    public void irRegistroResidentes() {
        ...
        controlador_residentes ctrlRes = new controlador_residentes(vistaR, menuFrame());
        ctrlRes.iniciar();
    ...
    public void irConsultas() {
        menuFrame().setVisible(false);
        new Formulario_Consultas(menuFrame()).setVisible(true);
    }
