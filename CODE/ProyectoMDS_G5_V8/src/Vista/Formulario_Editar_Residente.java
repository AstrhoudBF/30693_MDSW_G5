...
public class Formulario_Editar_Residente extends JFrame {
    ...
    private void initComponents() {
        ...
        // Fila 5 — Estado del residente
        addLbl(pnlDatos, "Estado residente: *", 10, 210, 155, 22);
        comboEstadoRes = new JComboBox<>(new String[]{"Activo", "Cancelado"});
        comboEstadoRes.setFont(new Font("Segoe UI", Font.PLAIN, 13));
        comboEstadoRes.setBounds(170, 210, 130, 26); pnlDatos.add(comboEstadoRes);
        ...
        // Nota informativa
        JLabel lblNota = new JLabel("Los cambios se aplicarán directamente en la base de datos.");
