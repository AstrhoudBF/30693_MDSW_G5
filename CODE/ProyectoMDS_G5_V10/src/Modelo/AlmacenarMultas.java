...
public class AlmacenarMultas {
    ...
    // Anula (lógicamente) la multa cambiando su estado a "Anulada",
    // sin eliminar el documento de la base de datos.
    public void anular(String id) {
        coleccion.updateOne(
            new Document("_id", new ObjectId(id)),
            new Document("$set", new Document("Estado", "Anulada"))
        );
    }
