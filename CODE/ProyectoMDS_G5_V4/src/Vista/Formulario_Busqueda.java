...
public class Formulario_Busqueda extends javax.swing.JFrame implements interfaz_busqueda {
    ...
    private void initComponents() {
        ...
        btn_eliminar = mkBtn("🗑 Eliminar residente", new Color(180, 30, 30), Color.WHITE);
        btn_eliminar.setBounds(675, 18, 210, 30);
        btn_eliminar.setEnabled(false);
        pnlAcciones.add(btn_eliminar);
    ...
    @Override public JButton    getBtnEliminar()     { return btn_eliminar;       }
    ...
    @Override public void limpiarTabla()             { modeloTabla.setRowCount(0); btn_modificar.setEnabled(false); btn_eliminar.setEnabled(false); }
